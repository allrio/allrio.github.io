$(document).ready(function() {
  ...
  window.addEventListener('scroll', function() {
    ...
    dotContainer.style.right = (scrollPos / screenHeight) * 24 + 'px';

    //Scroll Dot Indicator
    if (parseInt(dotContainer.style.right.substring(0, 4)) > 24) {
      dotContainer.style.right = '24px'
    };
